...
| GASTOS DE PERSONAL ADMINSTRATIVO             | Promedio PTA y Número de estudiantes                                 |
| GASTOS DE PERSONAL - PTA REMUNRACION DOCENTE | Cursos Cruzados                                                      |
| GASTOS DE VIAJE Y TRANSPORTE                 | Número de estudiantes por programa                                   |
| GESTION DE BIENES                            | Promedio: % de Uso Laboratorios & Número de estudiantes por programa |
...
| SERVICIOS PUBLICOS                           | Número de estudiantes por programa                                   |
...
$$\frac{\frac{\text{(PTA por programa de pregrado)}}{\text{(Total PTA pregrado)}} + \frac{\text{(No. estudiantes por programa de pregrado)}}{\text{(Total estudiantes de posgrado)}}}{2}$$
$$= \% \text{ participación por programa}$$

**Posgrado**

$$\frac{\frac{\text{(PTA por programa de posgrado)}}{\text{(Total PTA posgrado)}} + \frac{\text{(No. estudiantes por programa de posgrado)}}{\text{(Total estudiantes de posgrado)}}}{2}$$
$$= \% \text{ participación por programa}$$
...
**Posgrado**                                                                                                                                                                                                                    
$$\frac{\frac{\text{(\% de uso de laboratorios de cada posgrado)}}{\text{(Total \% de uso de laboratorios de posgrado)}} + \frac{\text{(PTA por programa de posgrado)}}{\text{(Total PTA posgrado)}}}{2}$$
$$= \% \text{ participación por programa}$$
...
**Posgrado**                                                                                                                                                                                                  
$$\frac{\text{(PTA por programa curricular de posgrado)}}{\text{(Total PTA posgrado)}} \times \text{Costos de la Agrupación de Impuestos, Tasas y Contribuciones}$$
