...
\hypersetup{
  pdftitle={Paquete UnalR   Manual de usuario},
  pdfauthor={Jane Doe},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{Paquete UnalR Manual de usuario}
\author{Jane Doe}
\date{09-14-2022}
...
\hypertarget{puxe1rrafo-justificado}{%
\section{Párrafo Justificado}\label{puxe1rrafo-justificado}}
...
\hypertarget{puxe1rrafo-justificado-1}{%
\section{Párrafo Justificado}\label{puxe1rrafo-justificado-1}}
