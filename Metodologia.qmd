...
El diseño del modelo de costos requiere, entre otras cosas, la definición de los inductores de costos, estos son los factores que permiten llevar a cabo la asignación de los costos a los objetos del costo dentro del modelo a través de un prorrateo, la Contaduría General de la Nación (2008, pág. 48) [@Contaduria pp. 48], define los direccionadores o inductores de costos, así: 
...
Un inductor o direccionador puede ser financiero o no financiero, adicionalmente, las organizaciones pueden determinar un único direccionador, o múltiples de acuerdo con las características del proceso (Horngren, Foster, & Datar, 2002) [@HorngrenFoster]. 
...
tabla1 <- data.frame(
  AGRUPACIÓN = c("ASEO, CAFETERIA Y VIGILANCIA", 
                 "BIENESTAR", 
                 "GASTOS DE PERSONAL – PTA REMUNERACION DOCENTE",
                 ...
                 "MATERIALES, SUMINISTROS E INSUMOS",
                 "SERVICIOS CONTRATADOS",
                 "SERVICIOS PUBLICOS", "OTROS COSTOS"),
  col1 = c(
    "% de asignación costos de aseo, cafetería y vigilancia",
    "% de asignación costos de bienestar",
    "Se distribuye según las actividades establecidas en el acuerdo 027 de 2012 , calculando de acuerdo con la información suministrada por los docentes los porcentajes de dedicación a cada actividad para realizar las distribuciones correspondientes en pregrado, posgrado, investigación y extensión.",
    "% de asignación costos distribuidos PTA + servicios contratados", 
    "% de asignación costos de viaje y transporte",
    "% de asignación costos de gestión de bienes",
    "% de asignación costos de impuestos, tasas y contribuciones", 
    "% de asignación costos de materiales, suministros e insumos",
    "% de asignación costos de servicios contratados",
    "% de asignación costos de servicios públicos",
    "% de asignación costos de otros costos"
  ),
  col2 = c(
    "BASE MIXTA: Número de Estudiantes / Total de personas PTA + Serv Contratados",
    "Directo a pregrado", "", 
    "% de asignación de la agrupación",
  ...
  col4 = c(
    ...
    "Número de estudiantes por programa",
    "" ,
    "Promedio PTA y Número de estudiantes", 
    "Número de estudiantes por programa", 
    "Promedio: % de Uso de Laboratorios por programa & Número de estudiantes por programa",
    "PTA por Programa",
    "% de uso de Laboratorios por programa",
    "Número de contratistas",
    "Número de estudiantes por programa",
    "Promedio: PTA y Número de estudiantes por Programa"
  )
)
colnames(tabla1) <- c("AGRUPACIÓN",	"DISTRIBUCION COSTOS DEL NIVEL NACIONAL Y UNIMEDIOS",	"REDISTRIBUCIÓN DE COSTOS DE PREGRADO  Y OTROS COSTOS",	"DISTRIBUCIÓN DE COSTOS INDIRECTOS A NIVEL FACULTAD",	"COSTOS POR PROGRAMA")
```
...
gt_tbl1 <- 
  gt(tabla1) |>
  cols_merge_range(
    col_begin = "DISTRIBUCION COSTOS DEL NIVEL NACIONAL Y UNIMEDIOS",
    col_end = "COSTOS POR PROGRAMA",
    rows = 3,
    autohide = F
  )
# Renderizar la tabla
